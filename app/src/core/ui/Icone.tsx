...
export type NomeIcone = 'painel' | 'financeiro' | 'lancamentos' | 'contas' | 'cartao' | 'categorias' | 'negocios' | 'pessoas' | 'contratos' | 'apps' | 'notificacoes' | 'disparos' | 'ftth' | 'estoque' | 'os' | 'portal' | 'configuracoes' | 'sair'
