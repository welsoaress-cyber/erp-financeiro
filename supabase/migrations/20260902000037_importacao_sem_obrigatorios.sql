-- =============================================================================
-- 0037 · Importação: só o nome é obrigatório
-- =============================================================================
-- Pedido do proprietário: importar com o mínimo e completar depois na tela.
-- Padrões quando vazio: telefone → sem aviso de WhatsApp até preencher;
-- dia de vencimento → 10; data de início → hoje. O que vier preenchido
-- continua validado (telefone com DDD, CPF com dígito, dia 1..31).
-- =============================================================================
...
comment on function public.importar_clientes(uuid, jsonb, boolean, date) is
  'Importa clientes/planos/contratos (jsonb). Só o nome é obrigatório; padrões: dia 10, início hoje, plano = nome do negócio. Simulação executa e desfaz.';
