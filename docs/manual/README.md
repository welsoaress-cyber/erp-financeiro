...
- **Quem é a pessoa na despesa:** é o **fornecedor** (quem vendeu), não o cliente. O cliente da compra vai no campo **Contrato**. Em receita é o contrário: a pessoa vem do contrato e fica travada, porque quem paga é o cliente.
