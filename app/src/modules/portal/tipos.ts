...
export interface IndicacaoAdmin { id: string; negocio_id: string; indicador_pessoa_id: string; nome_indicado: string; telefone_indicado: string; indicado_pessoa_id: string | null; status: 'pendente' | 'convertida' | 'cancelada'; beneficio_valor: number; observacao: string | null; criado_em: string; convertida_em: string | null; presente_item_id: string | null; presente_custo: number | null; presente_entregue_em: string | null }
