...
- Etapa 29 (A/B/C): `docs/31-ordens-servico.md` (Ordens de Serviço: chamados técnicos, bolsa do técnico, tempo desde o agendamento, comissão no Contas a Pagar, payback; 29B = login/tela do técnico; 29C = portal + WhatsApp).
