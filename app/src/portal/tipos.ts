...
export interface Indicacao { id: string; negocio: string; nome_indicado: string; status: 'pendente' | 'convertida' | 'cancelada'; beneficio_valor: number; criado_em: string; convertida_em: string | null; presente_item_id: string | null; presente: string | null; presente_foto: string | null; presente_entregue_em: string | null; aguardando_escolha: boolean }
export interface PresenteOpcao { premio_id: string | null; item_id: string; nome: string; foto: string | null; ja_escolhido: boolean }
export interface VitrinePublica { negocio: string; cor: string; logo: string | null; texto: string | null; faixas: { faixa: number; nome: string; teto: number }[]; premios: { nome: string; foto: string | null; faixa: number }[] }
