...
## Produção
- Verificação consolidada: `supabase/tests/verificar_tudo.sql` (esperado 26 de 26). Diagnóstico somente leitura: `supabase/scripts/diagnostico_contratos.sql`.
...
- Etapa 18: `docs/26-projecao-contratos.md` (meses futuros de contrato são projeção derivada, nunca lançamentos pré-gerados).
